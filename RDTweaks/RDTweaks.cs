...
public class RDTweaks : BaseUnityPlugin
{
	...
	public void Awake()
	{
		...
		if (PConfig.SkipOnStartupTo.Value != SkipLocation.MainMenu)
			Harmony.CreateAndPatchAll(typeof(SkipOnStartup), MyPluginInfo.PLUGIN_GUID + ".SkipOnStartup");

		if (PConfig.AlwaysUseSteam.Value)
			Harmony.CreateAndPatchAll(typeof(AlwaysUseSteam), MyPluginInfo.PLUGIN_GUID + ".AlwaysUseSteam");

		Harmony.CreateAndPatchAll(typeof(SkipTitle), MyPluginInfo.PLUGIN_GUID + ".SkipTitle");
		Harmony.CreateAndPatchAll(typeof(CLSScrollWheel), MyPluginInfo.PLUGIN_GUID + ".CLSScrollWheel");
		Harmony.CreateAndPatchAll(typeof(PixelFontInputs), MyPluginInfo.PLUGIN_GUID + ".PixelFontInputs");
		Harmony.CreateAndPatchAll(typeof(SkipToLibrary), MyPluginInfo.PLUGIN_GUID + ".SkipToLibrary");
		Harmony.CreateAndPatchAll(typeof(HideMouseCursor), MyPluginInfo.PLUGIN_GUID + ".HideMouseCursor");
		Harmony.CreateAndPatchAll(typeof(BlockMouseInGame), MyPluginInfo.PLUGIN_GUID + ".BlockMouseInGame");
